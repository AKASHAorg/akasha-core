...
type AkashaReflectStream @createModel(accountRelation: SET, description: "Moderated Beam Reflections v0.2", accountRelationFields: ["reflectionID"]) @createIndex(fields:[{path: "active"},{path: "reflectionID"}, {path: "createdAt"}, {path: "status"}, {path: "moderationID"}, {path: "beamID"}]){
