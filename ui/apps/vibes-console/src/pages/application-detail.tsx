...
import { ApplicationApprovedCard, ApplicationDetail } from '../components/applications/application';
import { generateApplicationData } from '../utils';
import routes, { REVIEW_HUB } from '../routes';

export type ApplicationDetailPageProp = {
  applicationId: string;
};

export const ApplicationDetailPage: React.FC<ApplicationDetailPageProp> = props => {
  ...
  const handleCancelButtonClick = () => {
    navigate({
      to: '/applications-center/applications/application/$applicationId/withdraw',
      params: {
        applicationId,
      },
    });
