...
const Status = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <circle fill="#FFFFFF" stroke="#000000" strokeMiterlimit="10" cx="389.2" cy="379.4" r="278.8" />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      fill="#4360DF"
      d="M444.7,375.9c-45.6,2.6-74.2-8-119.8-5.3c-11.3,0.6-22.5,2.3-33.6,4.9c6.7-84.1,66.4-157.7,147.6-162.4
