      ...
      componentWrapper = customRender(
        wrapWithTheme(
          <TransparencyLogBanner
            ...
            content="Here you will find the moderated posts, replies, and accounts of Akasha World. We do not reveal any personal information of the author or submitter(s) to protect their privacy."
            keptCount={count.kept}
            keptCountLabel="kept"
            totalCountLabel="total"
            delistedCount={count.delisted}
            delistedCountLabel="delisted"
            footerLabel1="Check out the Akasha World "
            footerLabel2=" here."
