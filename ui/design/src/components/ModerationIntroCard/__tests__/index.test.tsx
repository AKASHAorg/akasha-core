      ...
      componentWrapper = customRender(
        wrapWithTheme(
          <ModerationIntroCard
            ...
            descriptionLine1Label="Here you will find the moderated posts, replies, and accounts of Akasha World. We do not reveal any personal information of the author or submitter(s) to protect their privacy."
