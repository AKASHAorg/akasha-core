...
export declare type ActivityFn = (location: Location, pathToActiveWhen: (path: string, exact?: boolean) => (location: Location) => boolean) => boolean;
...
export declare type IntegrationConfig = IAppConfig | IWidgetConfig | LayoutConfig;
...
export declare type AppOrWidgetDefinition = string | {
    name: string;
    version: string;
};
