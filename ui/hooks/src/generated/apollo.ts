...
/**
 * __useGetFollowDocumentsQuery__
 *
 * To run a query within a React component, call `useGetFollowDocumentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetFollowDocumentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetFollowDocumentsQuery({
 *   variables: {
 *      after: // value for 'after'
 *      before: // value for 'before'
 *      first: // value for 'first'
 ...
 * });
 */
export function useGetFollowDocumentsQuery(baseOptions?: Apollo.QueryHookOptions<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>(GetFollowDocumentsDocument, options);
      }
export function useGetFollowDocumentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>(GetFollowDocumentsDocument, options);
        }
export function useGetFollowDocumentsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetFollowDocumentsQuery, Types.GetFollowDocumentsQueryVariables>(GetFollowDocumentsDocument, options);
        }
export type GetFollowDocumentsQueryHookResult = ReturnType<typeof useGetFollowDocumentsQuery>;
