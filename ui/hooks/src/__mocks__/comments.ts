...
export const mockGetComment = { getComment: mockGetComments.getComments.results[0] };

export const mockDeleteCommentResponse = {
  removeComment: true,
};
export const mockDeleteCommentInput = COMMENT_ID;

export const mockCreateCommentResponse = {
  addComment: COMMENT_ID,
};
export const mockCreateCommentInput = {
  metadata: {
    app: 'AkashaApp',
    images: [],
    tags: [],
  ...
  textContent: 'test',
  author: mockGetComment.getComment.author.ethAddress,
  postID: mockGetComment.getComment.postId,
};

export const mockEditCommentResponse = { editComment: true };
export const mockEditCommentInput = {
  metadata: {
    app: 'AkashaApp',
    images: [],
    tags: [],
