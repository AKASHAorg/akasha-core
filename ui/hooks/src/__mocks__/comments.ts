...
export const mockCreateCommentInput = {
  ...
  textContent: 'test',
  author: mockGetComment.data.getComment.author.ethAddress,
  postID: mockGetComment.data.getComment.postId,
};

export const mockEditCommentResponse = { data: { editComment: true } };
