...
describe('App Loader', () => {
  ...
  it.todo('must get a list of installed apps');
  it.todo('must load the script files for each installed apps');
  it.todo('must store the extension points of each installed apps');
});
