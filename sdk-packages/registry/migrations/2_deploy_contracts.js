...
module.exports = function(deployer, network, accounts) {
  ...
  deployer.deploy(ENS)
    ...
    .then(function() {
      return deployer.deploy(AkashaRegistrar, ens.address);
    })
    .then(function(akRegistrarInstance) {
      akRegistrar = akRegistrarInstance;
      return registerRootNode(registrar, akRegistrar);
    })
};
