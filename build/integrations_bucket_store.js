...
(async () => {
  ...
  const sources = [
    ...
    {package: require('../ui/apps/app-center/package.json'), type: TYPE_APP, path: path.resolve(__dirname, '../ui/build/apps', 'app-center')},
    {package: require('../ui/apps/bookmarks/package.json'), type: TYPE_APP, path: path.resolve(__dirname, '../ui/build/apps', 'bookmarks')},
    {package: require('../ui/apps/legal/package.json'), type: TYPE_APP, path: path.resolve(__dirname, '../ui/build/apps', 'legal')},
    {package: require('../ui/apps/notifications/package.json'), type: TYPE_APP, path: path.resolve(__dirname, '../ui/build/apps', 'notifications')},
