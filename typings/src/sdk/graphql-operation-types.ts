...
export type UserProfileFragmentFragment = { pubKey: string, name?: string | null, userName?: string | null, avatar?: string | null, coverImage?: string | null, description?: string | null, ethAddress: string, totalPosts?: string | null, totalFollowers: number, totalFollowing: number };
...
export type PostResultFragment = { title?: string | null, type: Types.PostType, _id: string, creationDate: string, updatedAt?: string | null, tags?: Array<string> | null, totalComments: string, quotedBy?: Array<string | null> | null, content?: Array<{ provider: string, property: string, value: string }> | null, author: { pubKey: string, name?: string | null, userName?: string | null, avatar?: string | null, coverImage?: string | null, description?: string | null, ethAddress: string, totalPosts?: string | null, totalFollowers: number, totalFollowing: number }, quotedByAuthors?: Array<{ pubKey: string, name?: string | null, userName?: string | null, avatar?: string | null, coverImage?: string | null, description?: string | null, ethAddress: string, totalPosts?: string | null, totalFollowers: number, totalFollowing: number } | null> | null, quotes?: Array<{ title?: string | null, type: Types.PostType, _id: string, creationDate: string, updatedAt?: string | null, tags?: Array<string> | null, content?: Array<{ provider: string, property: string, value: string }> | null, author: { pubKey: string, name?: string | null, userName?: string | null, avatar?: string | null, coverImage?: string | null, description?: string | null, ethAddress: string, totalPosts?: string | null, totalFollowers: number, totalFollowing: number } }> | null };
