...
type ExtensionWorldPreviewConfig = {
...
export class TestModeLoader implements ITestModeLoaderPlugin {
  ...
  #user: { id?: string };
  #logger: ILogger;
  readonly #importModule: ExtensionWorldPreviewConfig['importModule'];
  readonly #registerAdditionalResources: ExtensionWorldPreviewConfig['registerAdditionalResources'];
  readonly #initializeExtension: ExtensionWorldPreviewConfig['initializeExtension'];
  readonly #registerExtension: ExtensionWorldPreviewConfig['registerExtension'];
  readonly #finalizeInstall: ExtensionWorldPreviewConfig['finalizeInstall'];
  listeners: (({
    currentStatus,
    errorStatus,
  }: {
  ...
  constructor(config: ExtensionWorldPreviewConfig) {
    this.#sdk = getSDK();
    this.#user = {};
    this.#logger = this.#sdk.services.log.create('ExtensionWorldPreview');
    ...
    this.listeners = [];
    console.log('world preview config');
  }
