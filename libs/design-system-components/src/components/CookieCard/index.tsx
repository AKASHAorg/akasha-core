        ...
        <Stack spacing={1}>
          ...
          <Text variant="body2">
            ...
            <Button variant="link" asChild>
              <a rel="noreferrer" href={paragraphTwo.analyticsURL} className="p-0">
            ...
            <Button variant="link" onClick={paragraphTwo.onSettingsClick} className="p-0">
          ...
          <Text variant="body2">
            ...
            <Button variant="link" onClick={paragraphThree.onPrivacyClick} className="p-0">
