...
const Autocomplete = React.forwardRef<React.ElementRef<typeof Command>, AutoCompleteProps>(
  (
    { options = [], emptyMessage, disabled, loading = false, placeholder, className, ...props },
    ref,
  ) => {
